...
showtext_auto()
matrix_cluster<- read.csv('XX/matrix_cluster_result_admet.csv',check.names=F)
matrix_type<- read.csv('XX/matrix_type_result_admet.csv',check.names=F)
...
#annotation
matrix_herb_type<- read.csv('XX/matrix_herb_result_admet.csv',check.names=F)
